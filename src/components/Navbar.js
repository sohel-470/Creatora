  ...
  return (
    <nav className='text-slate-900 flex justify-between items-center px-12 h-24 bg-transparent'>
        ...
        <ul className='flex gap-10 items-center font-medium cursor-pointer'>
            ...
            <li>
                <button className='bg-gradient-to-r from-purple-600 to-blue-500 text-white px-7 py-2.5 rounded-full font-semibold hover:shadow-lg hover:shadow-purple-500/30 transition-all'>
                    Sign In
                </button>
            </li>
        </ul>
